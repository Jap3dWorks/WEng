// [[file:../WCollision.org::wcl::component::CollisionLevelData][wcl::component::CollisionLevelData]]
#pragma once
...
#define _WCLASS_ CollisionLevelData
#define _PWCLASS_ WComponent
#define _WENG_API_ WCOLLISION_API
#define _WCLASS_NAMESPACE_ wcl::component
...
#define _STR_WCLASS_NAMESPACE_ wcl__component
...
#define WOBJECT_BODY                               \
    public:                                        \
    constexpr CollisionLevelData() noexcept = default;           \
    constexpr CollisionLevelData(const CollisionLevelData &) = default;        \
    constexpr CollisionLevelData(CollisionLevelData &&) noexcept=default;      \
    CollisionLevelData & operator=(const CollisionLevelData &) = default;      \
    CollisionLevelData & operator=(CollisionLevelData &&) = default;           \
    ~CollisionLevelData() = default;                             \
    static const WClass * StaticClass() noexcept ; \
    const WClass * Class() const override {        \
        return CollisionLevelData::StaticClass();                \
    }
// wcl::component::CollisionLevelData ends here
