// [[file:../WCollision.org::wcl::component::Collision][wcl::component::Collision]]
#pragma once
...
#define WOBJECT_BODY                               \
    ...
    const WClass * Class() const override {        \
        return Collision::StaticClass();                \
    }
// wcl::component::Collision ends here
