// [[file:../WObjects.org::wcm::Movement-WEng-hpp][wcm::Movement-WEng-hpp]]
#pragma once
...
#define WOBJECT_BODY                               \
    public:                                        \
    constexpr Movement() noexcept = default;           \
    constexpr Movement(const Movement &) = default;        \
    constexpr Movement(Movement &&) noexcept=default;      \
    ...
    const WClass * Class() const override {        \
        return Movement::StaticClass();                \
    }
// wcm::Movement-WEng-hpp ends here
