// [[file:../WObjects.org::was::RenderPipeline-wengine-hpp][was::RenderPipeline-wengine-hpp]]
#pragma once
...
#define _WCLASS_ RenderPipeline
...
#define WOBJECT_BODY                               \
    public:                                        \
    constexpr RenderPipeline() noexcept = default;           \
    constexpr RenderPipeline(const RenderPipeline &) = default;        \
    ...
    const WClass * Class() const override {        \
        return RenderPipeline::StaticClass();                \
    }
// was::RenderPipeline-wengine-hpp ends here
