// [[file:../WObjects.org::wcm::CameraInput-wengine-hpp][wcm::CameraInput-wengine-hpp]]
#pragma once
...
#define _STR_WCLASS_NAMESPACE_ wcm
...
#define WOBJECT_BODY                               \
    public:                                        \
    constexpr CameraInput() noexcept = default;           \
    constexpr CameraInput(const CameraInput &) = default;        \
    constexpr CameraInput(CameraInput &&) noexcept=default;      \
    CameraInput & operator=(const CameraInput &) = default;      \
    CameraInput & operator=(CameraInput &&) = default;           \
    ~CameraInput() = default;                             \
    static const WClass * StaticClass() noexcept ; \
    const WClass * Class() const override {        \
        return CameraInput::StaticClass();                \
    }
// wcm::CameraInput-wengine-hpp ends here
