// [[file:../WObjects.org::wcm::StaticMesh-wengine-hpp][wcm::StaticMesh-wengine-hpp]]
#pragma once
...
#define WOBJECT_BODY                               \
    public:                                        \
    constexpr StaticMesh() noexcept = default;           \
    constexpr StaticMesh(const StaticMesh &) = default;        \
    constexpr StaticMesh(StaticMesh &&) noexcept=default;      \
    ...
    const WClass * Class() const override {        \
        return StaticMesh::StaticClass();                \
    }
// wcm::StaticMesh-wengine-hpp ends here
