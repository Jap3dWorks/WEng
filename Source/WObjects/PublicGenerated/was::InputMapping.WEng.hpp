// [[file:../WObjects.org::was::InputMapping-wengine-hpp][was::InputMapping-wengine-hpp]]
#pragma once
...
#define WOBJECT_BODY                               \
    public:                                        \
    constexpr InputMapping() noexcept = default;           \
    constexpr InputMapping(const InputMapping &) = default;        \
    constexpr InputMapping(InputMapping &&) noexcept=default;      \
    InputMapping & operator=(const InputMapping &) = default;      \
    InputMapping & operator=(InputMapping &&) = default;           \
    ~InputMapping() = default;                             \
    static const WClass * StaticClass() noexcept ; \
    const WClass * Class() const override {        \
        return InputMapping::StaticClass();                \
    }
// was::InputMapping-wengine-hpp ends here
