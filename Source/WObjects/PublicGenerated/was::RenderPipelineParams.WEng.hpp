// [[file:../WObjects.org::was::RenderPipelineParams-wengine-hpp][was::RenderPipelineParams-wengine-hpp]]
#pragma once
...
#define _WCLASS_ RenderPipelineParams
#define _PWCLASS_ WAsset
#define _WENG_API_ WOBJECTS_API
#define _WCLASS_NAMESPACE_ was
...
#define _STR_WCLASS_NAMESPACE_ was
...
#define WOBJECT_BODY                               \
    public:                                        \
    constexpr RenderPipelineParams() noexcept = default;           \
    constexpr RenderPipelineParams(const RenderPipelineParams &) = default;        \
    constexpr RenderPipelineParams(RenderPipelineParams &&) noexcept=default;      \
    RenderPipelineParams & operator=(const RenderPipelineParams &) = default;      \
    RenderPipelineParams & operator=(RenderPipelineParams &&) = default;           \
    ~RenderPipelineParams() = default;                             \
    static const WClass * StaticClass() noexcept ; \
    const WClass * Class() const override {        \
        return RenderPipelineParams::StaticClass();                \
    }
// was::RenderPipelineParams-wengine-hpp ends here
