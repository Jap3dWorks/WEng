// [[file:../WObjects.org::wdirectionallightcomponent-wengine-hpp][wdirectionallightcomponent-wengine-hpp]]
#pragma once
...
#define WOBJECT_BODY                               \
    public:                                        \
    constexpr Directional() noexcept = default;           \
    constexpr Directional(const Directional &) = default;        \
    constexpr Directional(Directional &&) noexcept=default;      \
    ...
    const WClass * Class() const override {        \
        return Directional::StaticClass();                \
    }
