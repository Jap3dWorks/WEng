// [[file:../WEngineObjects.org::wdirectionallightcomponent-wengine-hpp][wdirectionallightcomponent-wengine-hpp]]
#pragma once
...
#define _WCLASS_ WDirectionalLightComponent
...
#define WOBJECT_BODY                               \
    public:                                        \
    constexpr WDirectionalLightComponent() noexcept = default;           \
    constexpr WDirectionalLightComponent(const WDirectionalLightComponent &) = default;        \
    constexpr WDirectionalLightComponent(WDirectionalLightComponent &&) noexcept=default;      \
    WDirectionalLightComponent & operator=(const WDirectionalLightComponent &) = default;      \
    WDirectionalLightComponent & operator=(WDirectionalLightComponent &&) = default;           \
    ~WDirectionalLightComponent() override = default;                    \
    static const WClass * StaticClass() noexcept ; \
    const WClass * Class() const override {        \
        return WDirectionalLightComponent::StaticClass();                \
    }
// wdirectionallightcomponent-wengine-hpp ends here
