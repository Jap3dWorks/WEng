...
public:
    ...
    WVkAttachmentRAII() = default;

    WVkAttachmentRAII(const WVkAttachmentRAII&) = delete;
    WVkAttachmentRAII& operator=(const WVkAttachmentRAII&) = delete;

    WVkAttachmentRAII(VkDevice in_device,
    ...
    WVkAttachmentRAII(WVkAttachmentRAII&& other) noexcept :
    ...
    WVkAttachmentRAII& operator=(WVkAttachmentRAII&& other) noexcept { 
        if (this != &other) {
            Destroy();
