...
namespace wvk::raii {
    ...
    public:
        ...
        Swapchain(const VkDevice & in_device,
        ...
        constexpr const VkSwapchainKHR & GetSwapchain() const {
            return swapchain_;
        }
        ...
        constexpr VkExtent2D GetExtent() const {
            return extent_;
        }

        constexpr const std::vector<VkImage> & GetImages() const {
            return images_;
        }

        constexpr const std::vector<VkImageView> & GetViews() const {
            return views_;
        }

        constexpr const std::vector<VkDeviceMemory> & GetMemory() const {
            return memory_;
        }
