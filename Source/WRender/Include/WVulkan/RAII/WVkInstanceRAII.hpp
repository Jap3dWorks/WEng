...
struct WVkInstanceCreator {
    ...
    VkInstance Create(bool in_enable_validation_layers,
        ...
        VkApplicationInfo app_info = wvk::types::VkApplicationInfo();
        ...
        VkInstanceCreateInfo create_info = wvk::types::VkInstanceCreateInfo();
...
using WVkInstanceRAII = wvk::raii::VkRAII<VkInstance, WVkInstanceCreator>;
