...
namespace wvk::raii::descriptors {
    ...
    public:
        ...
        GlobalDesc() = default;
        GlobalDesc(const GlobalDesc&) = delete;
        GlobalDesc& operator=(const GlobalDesc&) = delete;

        GlobalDesc(GlobalDesc&& other) noexcept
        ...
        GlobalDesc & operator=(GlobalDesc && other) noexcept {
            if (this != &other) {
                Destroy();
