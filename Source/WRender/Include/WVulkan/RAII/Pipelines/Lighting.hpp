...
#include "WVulkan/RAII/Pipelines/Lighting_lib.hpp"
...
namespace wvk::raii::pipelines {
    ...
    public:
        ...
        VkDescriptorPool const & DescriptorPool(std::uint32_t in_frame_index) const noexcept {
            return descpool_info_[in_frame_index];
        }

        VkDescriptorSetLayout const & DescriptorSetLayout() const noexcept {
            return descset_layout_;
        }

        VkPipeline const & Pipeline() const noexcept {
            return pipeline_;
        }

        VkPipelineLayout const & PipelineLayout() const noexcept {
            return pipeline_layout_;
        }

        void ResetDescriptorPool(std::uint32_t const & in_frame_index) {
    ...
    private:
        ...
        void InitializeDescSetLayout() {
            ...
            // albedo,emission,normal,orm,depth,(extra01),shadow
            
            // TODO: add shadow pass

            std::array<
                VkDescriptorSetLayoutBinding,
                WVK_GBUFFERS_COUNT + WVK_SHADOWMAP_COUNT
                > dsl_bindings{};
        ...
        void InitializeRenderPipeline(
            ...
            VkFormat color_format = WVK_LIGHTING_RENDER_COLOR_FORMAT;
    ...
    private:
        ...
        const std::string_view shader_path_{WVK_LIGHTING_SHADER_PATH};
