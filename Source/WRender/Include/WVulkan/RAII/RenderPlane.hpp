...
namespace wvk::raii{ 
    ...
    public:
        ...
        RenderPlane(const VkDevice & in_device,
        ...
        RenderPlane(const RenderPlane &)=delete;

        RenderPlane(RenderPlane && other) noexcept :
        ...
        RenderPlane & operator=(const RenderPlane &)=delete;

        RenderPlane & operator=(RenderPlane && other) noexcept {
            if (this != &other) {
                Destroy();
        ...
        const WVkMesh & GetRenderPlane() const noexcept {
