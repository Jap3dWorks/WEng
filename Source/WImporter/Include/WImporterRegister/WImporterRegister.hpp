...
namespace wim::imp_register {
    ...
    public:
         ...
         */
        template<CCallable<bool, wim::importer::WImporter*> TFn>
        ...
        TOptionalRef<wim::importer::WImporter> GetImporter(const char * in_extension) const {
    ...
    private:
        ...
        std::unordered_map<std::type_index, std::unique_ptr<wim::importer::WImporter>> reg_;
